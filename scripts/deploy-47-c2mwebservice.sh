...
scp root@192.168.20.47:/opt/jenkins/jenkins_home/workspace/C2M_WEBSERVICE_BUILD_TEST_47/c2mmanage/target/c2mwebservice.war root@192.168.20.47:/opt/apache-tomcat-7/webapps/
